#!/bin/bash
# Unchanged from erikvl87/docker-languagetool (LGPL-2.1):
# https://github.com/Erikvl87/docker-languagetool/blob/main/start.sh
# Reused verbatim so docker-compose.yml's existing langtool_*/Java_Xms/Java_Xmx
# environment section keeps working unmodified against this image.
